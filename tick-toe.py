...
class tictactoe:#tictactoe this is class name
    def __init__(self):
    ...
    def make_move(self,row,col):
        if self.board[row] [col] =="":
            ...
            if self.check_winner(self.current_player):
                messagebox.showinfo("Game is Over","The Winner is "+self.current_player)
                self.window.quit()
            elif self.is_draw():
                messagebox.showinfo("game is Over","it's a Draw")
                self.window.quit()
